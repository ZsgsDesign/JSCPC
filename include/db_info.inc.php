...
static 	$DB_NAME="jol";
static 	$DB_USER="root";
static 	$DB_PASS="elPci8W58rVZ2VbYJDZeJrg190tiFp";

static 	$OJ_NAME="JSCPC Online Judge";
static 	$OJ_HOME="./";
...
static  $OJ_DEBUG=false; //调试模式
if(isset($_GET['debug'])) $OJ_DEBUG=$_GET['debug']?true:false;
